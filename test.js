...
function fillW4EmployerFields(_a) {
  return __awaiter(this, arguments, void 0, function (_b) {
    ...
    var startDate = _b.startDate,
      ein = _b.ein,
      companyAddress = _b.companyAddress;
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          inputPdfPath = path_1.default.join(
            process.cwd(),
            "public",
            "fw4.pdf",
          );
        ...
        case 2:
          ...
          form
            ...
            .setText(startDate); // First Date of Employment
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            buffer_1.Buffer.from(modifiedPdf).toString("base64"),
          ]; // return as base64 for emailing or preview
      }
    });
  });
}
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          resend = new resend_1.Resend(
            process.env.RESEND_API_KEY ||
              "re_ZJmwoKa2_K5MSQg6RGo9iBWf18jC5DMXg",
          );
          _a.label = 2;
        case 2:
          _a.trys.push([2, 4, , 5]);
          return [
            ...
            resend.emails.send({
              to: applicant.email,
              from: "hello@invitationhomesrental.com",
              subject: "\u2705 Welcome to Invitation Home Rentals, ".concat(
                applicant.fullName,
                "!",
              ),
              html: html,
        ...
        case 3:
          ...
          console.log(
            "Email sent to "
              .concat(applicant.fullName, " (")
              .concat(applicant.email, ")"),
          );
          return [3 /*break*/, 5];
        case 4:
          err_1 = _a.sent();
